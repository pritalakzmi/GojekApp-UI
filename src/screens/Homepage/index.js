...
export default function Homepage() {
  return (
    <View style={styles.container}>
      ...
      {/* Content */}
      <ScrollView>
        <ImageBackground source={iklan} style={styles.image} />
        <Wallet />
        <Menu />
        <Rating />
      </ScrollView>
    ...
    <View style={wallet.container}>
      <View
        ...
        <View style={wallet.debit}>
          <Text style={wallet.saldo}>Rp500.000</Text>
          <Text style={wallet.coin}>10 Coins</Text>
        </View>
      </View>
      <View
        style={{
        ...
        <View style={{alignItems: 'center'}}>
          <View style={rating.content}>
            ...
            <View style={rating.description}>
              ...
              <Text style={rating.text}>Gacoan - Suhat Malang</Text>
              <Text style={rating.text}>10 Nov 18:30</Text>
            </View>
          </View>
